...
- **多源查询** — dushu.com → douban → Google Books，逐级兜底
...
| 优先级 | 数据源 | 说明 |
|--------|--------|------|
| 1 | dushu.com | 中文书籍，反爬宽松 |
| 2 | douban.com | 中文书籍丰富，反爬较严 |
| 3 | Google Books | 国际书籍 |
...
| 版本 | 地址 | 说明 |
|------|------|------|
| 微信小程序版 | https://github.com/MoyuOlogy/mini-bookscanner | 当前项目，微信小程序 + 腾讯云开发 |
| 本地 + 网页版 | https://github.com/MoyuOlogy/book-scanner | Python 后端 + 浏览器前端 |
